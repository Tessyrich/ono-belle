        ...
        >
          ...
          <div className="relative">
            ...
            <h2 className="mt-4 font-baby text-3xl uppercase leading-tight sm:text-4xl lg:text-5xl">
              Looking for a Nigerian
              <br className="hidden sm:block" /> distribution partner?
            </h2>
            <p className="mt-5 mx-auto max-w-xl text-base text-white/85">
              Tell us about your brand. We&apos;ll come back with a structured,
              channel-specific market-entry proposal within two business days.
            </p>
